          ...
          <div className="space-y-8 font-light">
              ...
              <div className="space-y-4 text-sm">
                <div>
                  ...
                  <p className="leading-relaxed">
                    If you submit data to us via a contact form, we collect the data entered in the form, 
                ...
                <div>
                  ...
                  <p className="leading-relaxed">
                    The website provider automatically collects information in so-called server log files, 
                    which your browser automatically transmits to us. This information comprises:
                  </p>
            ...
            <section>
              ...
              <div className="text-sm space-y-2">
                <p>You always have the right to request information about your stored data, its origin, its recipients, and the purpose of its collection at no charge. You also have the right to request that it be corrected, blocked, or deleted.</p>
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed">
                Currently, this website does not use analytics tools or third-party tracking services. 
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed">
                ...
                such as the inquiries you send to us as the site operator. You can recognize an encrypted connection by the fact 
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed">
                We store your data only as long as necessary to provide our services or as required by law. 
                Contact form data is typically deleted after your inquiry has been resolved, unless you have agreed to further communication.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed">
                If you have questions about this privacy policy or our data processing practices, 
